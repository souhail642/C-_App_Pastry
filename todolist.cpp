...
CToDoList::CToDoList()
{
    ...
    QLabel* plblPending = new QLabel("A faire", this);
    plblPending->setStyleSheet("font-size: 15pt;");
    pHLayoutLabels->addWidget(plblPending);

    QLabel* plblCompleted = new QLabel("Terminées", this);
